...
let deviceId;
function useDeviceId(global2 = swan) {
...
function parsePropType(type, defaultValue) {
  ...
  {
    if (defaultValue === false && isArray$1(type) && type.length === 2 && type.indexOf(String) !== -1 && type.indexOf(Boolean) !== -1) {
      return Boolean;
    }
  }
  return type;
...
function parse$1(componentOptions) {
  ...
  lifetimes.attached = function attached() {
    ...
    if (isPage(this) && this.$vm) {
      ...
      if (hasOwn$1(pageInstance, "_$args")) {
...
swan.createSubpackageApp = global.createSubpackageApp = createSubpackageApp;
/*!
 * vuex v4.0.2
 * (c) 2021 Evan You
 * @license MIT
