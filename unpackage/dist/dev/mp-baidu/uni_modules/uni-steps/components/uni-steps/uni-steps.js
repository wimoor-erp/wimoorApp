  ...
  return {
    a: common_vendor.f($props.options, (item, index, i0) => {
      return {
        ...
        c: index === $props.active ? $props.activeColor : $props.deactiveColor,
    ...
    g: common_vendor.f($props.options, (item, index, i0) => {
      return common_vendor.e({
        a: index,
        b: index <= $props.active && index !== 0 ? $props.activeColor : index === 0 ? "transparent" : $props.deactiveColor,
        c: index === $props.active
      }, index === $props.active ? {
        d: "50c4e207-0-" + i0,
        e: common_vendor.p({
        ...
        f: common_vendor.n($props.direction === "column" ? "uni-steps__column-check" : "uni-steps__row-check")
      } : {
        g: common_vendor.n($props.direction === "column" ? "uni-steps__column-circle" : "uni-steps__row-circle"),
        h: index < $props.active ? $props.activeColor : $props.deactiveColor
      }, {
        i: index < $props.active && index !== $props.options.length - 1 ? $props.activeColor : index === $props.options.length - 1 ? "transparent" : $props.deactiveColor
      });
    }),
