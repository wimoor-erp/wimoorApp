...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    y: common_vendor.f($data.weeks, (item, weekIndex, i0) => {
      return {
        a: weekIndex,
        b: common_vendor.f(item, (weeks, weeksIndex, i1) => {
          return {
            a: weeksIndex,
            b: "365fd21e-0-" + i0 + "-" + i1,
            c: common_vendor.p({
    ...
    z: {
      "handleMouse": common_vendor.o($options.handleMouse),
      "change": common_vendor.o($options.choiceDate)
    },
    A: !$props.insert && !$props.range && $props.typeHasTime
  }, !$props.insert && !$props.range && $props.typeHasTime ? {
    B: common_vendor.t($data.tempSingleDate ? $data.tempSingleDate : $options.selectDateText),
    C: {
    ...
    E: !$props.insert && $props.range && $props.typeHasTime
  }, !$props.insert && $props.range && $props.typeHasTime ? {
    F: common_vendor.t($data.tempRange.before ? $data.tempRange.before : $options.startDateText),
    G: {
      "updateModelValue": common_vendor.o(($event) => $data.timeRange.startTime = $event)
    },
    H: common_vendor.p({
      type: "time",
      start: $options.reactStartTime,
    ...
    J: common_vendor.t($data.tempRange.after ? $data.tempRange.after : $options.endDateText),
    K: {
      "updateModelValue": common_vendor.o(($event) => $data.timeRange.endTime = $event)
    },
    L: common_vendor.p({
      type: "time",
      end: $options.reactEndTime,
