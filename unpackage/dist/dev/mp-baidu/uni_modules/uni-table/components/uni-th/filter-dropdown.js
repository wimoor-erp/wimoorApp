  ...
  return common_vendor.e({
    ...
    l: common_vendor.f($data.dataList, (item, index, i0) => {
      return {
        ...
        d: common_vendor.t(item[$props.map.text]),
        e: common_vendor.s(item.styleIconText),
    ...
    R: {
      "maskClick": common_vendor.o($options.timepickerclose),
      "change": common_vendor.o($options.datetimechange)
    },
    S: common_vendor.p({
