...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    f: common_vendor.f($data.tableData, (item, index, i0) => {
      return common_vendor.e({
        a: index,
        b: common_vendor.t(item.account),
        c: "a9414ecc-5-" + i0 + "," + ("a9414ecc-4-" + i0),
        d: common_vendor.o(($event) => $options.unbindAccount(item.account)),
        e: $data.curuser.account != item.account
      }, $data.curuser.account != item.account ? {
        f: common_vendor.o(($event) => $options.changeAccount(item.account))
      } : {}, {
        g: "a9414ecc-6-" + i0 + "," + ("a9414ecc-4-" + i0),
