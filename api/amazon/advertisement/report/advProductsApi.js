...
function getProductAdsExtList(id,type,data){
	return request.post('/amazonadv/api/v1/advProductAdsManager/getProductAdsExtList/'+id+"/"+type,data);
}

 
export default{
	getProductAdList,getSumProductAd,getProductAdChart,getProductAdotherAsin,getProductAdsExtList,
}