...
function getAdgroupExtList(id,type,data){
	return request.post('/amazonadv/api/v1/advAdgroupManager/getAdgroupExtList/'+id+"/"+type,data);
}

 
export default{
	getAdGroupList,getSumAdGroup,getAdGroupSuggestBid,getAdGroupChart,getAdgroupExtList,
}