    ...
    <uni-card class="n-shadow " margin="8px" v-for="item in productList">
		<uni-row>
           <uni-col :span="24">
			...
			<view class="uni-flex-grow">
			<view class="uni-flex uni-between cell-b-8 uni-row-center">
			<view class="uni-h4 ">{{item.fromsku}}
			<uni-tag text="调出SKU" type="primary" size="mini"></uni-tag>
			</view>
		...
		<uni-row>
			...
			<uni-col :span="24">
				<view class="markbox-wrap   uni-flex uni-between uni-row-center">
					<text>
