<template>
	<view>
			<view style="margin-bottom: 50px;" >
						...
						<block v-for="(value, index) in listData" :key="index">
						  <view class="uni-list-cell" hover-class="uni-list-cell-hover">
						  	<view class="uni-media-list">
						  			<label  v-if="editable" class="radio" style="padding-top: 20px;"  >
						  		...
						  		<view class="uni-media-list-body"  >
						  			<view class="uni-media-list-text-top">
						  				 ...
						  				 <view><text class="text-orange" style="font-weight: bolder;">{{value.quantity}}</text> 
						  			            <text style="padding-left:10px;font-size: 10px !important;" class='light-font'>库存</text>
						  					    <input type="number"  v-if="editable" class="pullright" style="border: 1px solid #eee;border-radius: 3px;width: 50px;" v-model="value.amount"  :placeholder="value.amount" />
						  				 </view>
						  			</view>
						  		</view>
						  	</view>
				...
				<view v-if="editable" class="uni-container tabbar">
	...
	export default {
			...
			methods:{
				...
				getList(){
				   ...
				   warehouseApi.getShelfInventoryList(data).then((data)=> { 
							if(data.records){
