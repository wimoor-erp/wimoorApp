	                ...
	                <view class="uni-flex-item " >
						<view class="uni-flex uni-column">
							...
							<view class="flex-item ">
								 ...
								 <view   class="text-omit-1 cell-t-8 uni-h6">{{nameFunc(row.name)}}</view>
							   </view>
						                <view class="flex-item  ">
											 <view class="text-orange uni-h5 font-bold uni-right" >{{row.quantity}}</view>
											 <text  class='uni-h7 '> 暂存库存</text>
										</view>
										</view>
						                <view class="cell-t-8">
											<view>
