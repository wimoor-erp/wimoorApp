<template>
  ...
  <uni-card is-full class="n-shadow">
...
<script setup>
	...
	function handlePrint(row){
		printRef.value.openPop("rec-sku",null,row)
	}
	onShow(()=>{
		handlerQuery();
	})
