	...
	<view class="uni-flex uni-row pro-list">
		...
		<view class="flex-item">
			...
			<view class="sku cell-t-8 cell-b-8">
					...
					<view class="cell-t-8 uni-h6" v-if="isAssemblyItem==false">平台SKU:{{item.sellersku}}</view>
			...
			<view class="uni-flex">
				<view>
				<text v-if="isAssemblyItem==false"  class="text-orange uni-h5 font-bold">{{item.quantity}}</text>
				...
				<view v-if="isAssemblyItem==false" class="uni-h6 cell-l-8"><view><text class="uni-h5">{{item.invquantity}}</text></view>可用库存</view>
