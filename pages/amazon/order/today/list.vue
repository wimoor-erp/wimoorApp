			...
			class="n-shadow"  margin="8px 12px">
					  ...
					  <view class=" uni-h6 uni-flex uni-between ">
						  <view class="uni-flex uni-h6 cell-text-8 uni-column">
						   ...
						   <text >销量 <text class="text-black">{{row.QuantityOrdered}}</text> </text> 
						   <text>净销售额 <text class="text-black">{{formatFloat(row.total_price)}} </text> </text> 
						   <text>单价 <text class="text-black">{{formatFloat(row.price)}} </text></text>  
						  </view>
						  <view class="uni-flex uni-h6 cell-text-8 uni-column">
							  <text class="text-black">昨日</text>
						   <text>销量  <text class="text-black">{{row.QuantityOrdered_yy}} </text> </text> 
						   <text>净销售额  <text class="text-black">{{formatFloat(row.totalprice_yy)}} </text> </text> 
						   <text>单价  <text class="text-black">{{formatFloat(row.price_yy)}} </text> </text> 
						  </view>
						  <view class="uni-flex uni-h6 cell-text-8 uni-column">
							  <text class="text-black">上周同日</text>
						   <text>销量  <text class="text-black">{{row.QuantityOrdered_lw}}  </text> </text> 
						   <text>净销售额 <text class="text-black"> {{formatFloat(row.totalprice_lw)}}  </text> </text> 
						   <text>单价  <text class="text-black">{{formatFloat(row.price_lw)}}  </text> </text> 
						  </view>
					  </view>
   			</uni-card>
   		</template>
...
<style scoped>
   ...
   .cell-text-8 uni-text, .cell-text-8 text{
	   margin-bottom:8px;
   }
   .uni-affix-box{
	position: fixed;
